...
namespace BitcubeEval.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var collegeContext = _context.Students.Include(s => s.Degree);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DegreeID,ID,Forenames,Surname,Email,DateOfBirth")] Student student)
        {
            if (id != student.ID)
            {
                return NotFound();
